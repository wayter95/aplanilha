    ...
    <div class="box-body">
      <form @submit.prevent="updateRole">
        <div class="mb-4">
          ...
          <input type="text" class="ti-form-input" id="edit-name" v-model="form.name" required>
          <p v-if="form.errors.name" class="text-danger text-xs mt-1">{{ form.errors.name }}</p>
        </div>
        
        <div class="mb-4">
          <label for="edit-display_name" class="form-label">Nome de Exibição</label>
          <input type="text" class="ti-form-input" id="edit-display_name" v-model="form.display_name" required>
        ...
        <div class="mb-4">
          ...
          <textarea class="ti-form-input" id="edit-description" v-model="form.description" rows="3"></textarea>
