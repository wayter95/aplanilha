                    ...
                    <div class="space-y-6">
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          <div>
                            <label class="ti-form-label mb-2">Tipo de Contato</label>
                            <select v-model="form.type" class="ti-form-select rounded-lg">
                          ...
                          <div>
                            <label class="ti-form-label mb-2">Nome da Empresa *</label>
                            <input 
                              v-model="form.name"
                              type="text"
                              class="ti-form-input rounded-lg"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          <div>
                            <label class="ti-form-label mb-2">E-mail Principal</label>
                            <input 
                              v-model="form.email"
                              type="email"
                              class="ti-form-input rounded-lg"
                          ...
                          <div>
                            <label class="ti-form-label mb-2">Telefone Principal</label>
                            <input 
                              v-model="form.phone"
                              type="tel"
                              class="ti-form-input rounded-lg"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          <div>
                            <label class="ti-form-label mb-2">Nome da Linha</label>
                            <input 
                          ...
                          <div>
                            <label class="ti-form-label mb-2">Website</label>
                            <input 
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                          <div class="lg:col-span-2">
                            <label class="ti-form-label mb-2">Rua</label>
                            <input 
                          ...
                          <div>
                            <label class="ti-form-label mb-2">Número</label>
                            <input 
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                          <div>
                            <label class="ti-form-label mb-2">CEP</label>
                            <input 
                          ...
                          <div>
                            <label class="ti-form-label mb-2">Cidade</label>
                            <input 
                          ...
                          <div>
                            <label class="ti-form-label mb-2">Estado</label>
                            <input 
                        ...
                        <div>
                          <label class="ti-form-label mb-2">País</label>
                          <input 
      ...
      <div class="bg-bodybg dark:bg-dark rounded-xl shadow-lg max-w-2xl w-full mx-auto max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto p-6">
          <div class="space-y-6">
            ...
            <div>
              <h4 class="text-lg font-semibold text-defaulttextcolor dark:text-white mb-4">Informações Pessoais</h4>
              
              <div class="grid grid-cols-2 gap-4">
                <div>
                  <label class="ti-form-label mb-2">Nome *</label>
                  <input 
                ...
                <div>
                  <label class="ti-form-label mb-2">Sobrenome</label>
                  <input 
              ...
              <div class="grid grid-cols-2 gap-4 mt-4">
                <div>
                  <label class="ti-form-label mb-2">Função/Cargo</label>
                  <input 
                ...
                <div>
                  <label class="ti-form-label mb-2">Telefone Móvel</label>
                  <input 
            ...
            <!-- E-mails -->
            <div>
              <h4 class="text-lg font-semibold text-defaulttextcolor dark:text-white mb-4">E-mails</h4>
              
              <div v-for="(email, index) in contactPersonForm.emails" :key="index" class="flex gap-2 mb-3">
                <input 
                  v-model="contactPersonForm.emails[index]"
                  type="email"
                  class="ti-form-input rounded-lg flex-1"
            ...
            <div>
              ...
              <div v-if="contactPersonForm.notes.length === 0" class="text-center py-8">
              ...
              <div v-else class="space-y-3">
                <div 
                  ...
                  :key="index"
                  class="bg-light-100 dark:bg-dark-700 rounded-lg p-4"
                >
                  <div class="flex items-center justify-between mb-2">
                    <h5 class="font-medium text-defaulttextcolor dark:text-white">{{ note.name }}</h5>
                    <button 
    ...
    >
      <div class="bg-bodybg dark:bg-dark rounded-xl shadow-lg max-w-md w-full mx-auto">
        ...
        <div class="p-6 space-y-4">
          <div>
            <label class="ti-form-label mb-2">Título da Nota</label>
            <input 
          ...
          <div>
            <label class="ti-form-label mb-2">Conteúdo</label>
            <textarea 
          ...
          <div>
            <label class="ti-form-label mb-2">Data</label>
            <input 
