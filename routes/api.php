...
Route::prefix('api')->group(function () {
    ...
    */
    Route::prefix('document-templates')->group(function () {
        ...
        Route::get('/', [DocumentTemplateController::class, 'index'])->name('api.document-templates.index');
    ...
    */
    Route::prefix('user')->group(function () {
        Route::put('/personal-data', [UserSettingsController::class, 'updatePersonalData'])->name('api.user.personal-data');
        Route::put('/password', [UserSettingsController::class, 'updatePassword'])->name('api.user.password');
    });
    ...
    */
    Route::prefix('company')->group(function () {
        Route::put('/data', [CompanySettingsController::class, 'updateData'])->name('api.company.data');
    });
});
